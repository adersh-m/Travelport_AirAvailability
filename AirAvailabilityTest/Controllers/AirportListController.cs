...
using AirAvailabilityTest.UtilService;
using System;
...
{
    public class AirportListController : Controller
    {
        // GET: AirportList
        ...
        internal IDictionary<String, String> AllAirportsList()
        {
            ...
            retrieveReq.BillingPointOfSaleInfo = new UtilService.BillingPointOfSaleInfo()
            {
        ...
        internal IDictionary<String, String> GetAllAiportsFromParticualrCity(String cityName)
        {
            ...
            refDataSearchReq.BillingPointOfSaleInfo = new UtilService.BillingPointOfSaleInfo()
            {
                OriginApplication = "UAPI"
            };
            ...
            dataItem.ItemElementName = UtilService.ItemChoiceType1.Name;
