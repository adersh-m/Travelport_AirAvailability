using AirAvailabilityTest.UniversalService;
...
namespace AirAvailabilityTest.Controllers
{
    public class BookController : Controller
    {
        ...
        private AirPricingSolution AddAirPriceSolution(AirPricingSolution lowestPrice, AirService.AirItinerary airItinerary)
        {
            ...
            foreach (var priceInfo in lowestPrice.AirPricingInfo)
            {
                ...
                foreach (var allowanceInfo in priceInfo.BaggageAllowances.BaggageAllowanceInfo)
                {
                    ...
                    foreach (var bagDetails in allowanceInfo.BagDetails)
                    {
                        ...
                        {
                            List<TextInfo> restrictionTextList = new List<TextInfo>();
                            foreach (var bagResTextInfo in restriction.TextInfo)
                            {
                                TextInfo resText = new TextInfo()
                                {
                ...
                {
                    foreach (BaseBaggageAllowanceInfo embargoInfo in priceInfo.BaggageAllowances.EmbargoInfo)
                    {
                        ...
                        List<TextInfo> embargoTextList = new List<TextInfo>();
